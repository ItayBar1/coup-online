      ...
      <main className="relative z-10 pt-24 px-8 max-w-4xl mx-auto pb-16">
        ...
        <div className="border border-outline-variant/30 p-8 bg-surface-container/50 backdrop-blur-sm space-y-8">
          ...
          <div className="space-y-4 text-on-surface/80 font-body text-sm leading-relaxed">
            <h2 className="font-headline text-2xl text-on-surface tracking-tighter">
              GENERAL DIRECTIVES
            </h2>
            <p>
              Each operative maintains two influence cards face-down. These
              cards represent power within the government. Lose both and you are
              eliminated.
            </p>
            <p>
              On your turn, choose an action. Other operatives may challenge
              your claim or block your action depending on their own influence.
            </p>
          </div>
          ...
          <div className="space-y-4 text-on-surface/80 font-body text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                {
                  name: "FOREIGN AID",
                  desc: "Take 2 coins. Can be blocked by the Duke.",
                },
                {
                  name: "COUP",
                  desc: "Pay 7 coins to eliminate an operative. Cannot be blocked. Mandatory at 10+ coins.",
                },
              ].map((action) => (
                <div
                  key={action.name}
                  className="border border-outline-variant/30 p-4 bg-surface-container-low"
                >
                  <div className="font-label text-xs tracking-widest text-primary mb-2">
                    {action.name}
                  </div>
          ...
          <div className="space-y-4 text-on-surface/80 font-body text-sm leading-relaxed">
            ...
            <p className="font-label text-[10px] text-outline/60 tracking-widest">
              See FACTIONS for full character details.
            </p>
          </div>
        </div>
      </main>
