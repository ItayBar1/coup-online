  ...
  render() {
    ...
    return (
      ...
      >
        {/* Coin balance */}
        <div
          id={`coup-player-${encodeURIComponent(name)}`}
          className="flex items-center gap-4 [@media(max-height:500px)]:gap-2 px-6 [@media(max-height:500px)]:px-3 border-r border-outline/10 h-full shrink-0"
        >
          ...
          <div>
            <span className="font-label text-[10px] text-outline uppercase block tracking-widest [@media(max-height:500px)]:hidden">
              BALANCE
            </span>
          ...
          {!isForced && (
            <>
              ...
              >
                ...
                <span className="font-label text-[9px] font-bold uppercase tracking-widest mt-1 [@media(max-height:500px)]:hidden">
                  INCOME
                </span>
              </button>
              <button
        ...
        {!isForced && (
          <div className="flex gap-1 px-6 h-full items-center overflow-x-auto">
            ...
            >
              <span className="material-symbols-outlined text-[#bbcf83]">
                account_balance
              </span>
              <span className="font-label text-[9px] text-[#bbcf83] mt-1 uppercase tracking-widest [@media(max-height:500px)]:hidden">
                TAX
              </span>
            </button>
            <button
            ...
            >
              <span className="material-symbols-outlined text-[#9a1a1a]">
                person_remove
              </span>
              <span className="font-label text-[9px] text-[#9a1a1a] mt-1 uppercase tracking-widest [@media(max-height:500px)]:hidden">
                ASSASSINATE
              </span>
            </button>
            <button
            ...
            >
              <span className="material-symbols-outlined text-[#a88a86]">
                handshake
              </span>
              <span className="font-label text-[9px] text-[#a88a86] mt-1 uppercase tracking-widest [@media(max-height:500px)]:hidden">
                STEAL
              </span>
            </button>
            <button
            ...
            >
              <span className="material-symbols-outlined text-[#cdc6b2]">
                currency_exchange
              </span>
              <span className="font-label text-[9px] text-[#cdc6b2] mt-1 uppercase tracking-widest [@media(max-height:500px)]:hidden">
                EXCHANGE
              </span>
            </button>
          </div>
        ...
        {this.state.actionError && (
          <p className="font-label text-xs text-error ml-4 tracking-widest shrink-0">
            {this.state.actionError}
          </p>
        )}
      </footer>
